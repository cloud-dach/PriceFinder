...
<body>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand pull-left" href="/"><em>Price Finder </em><small>v3.0</small></a>
  ...
  Input the item for which you would like to check its price:
	  <table style="margin: 0px auto;">
	  	...
	  	<tr>
	  		<td>
	  			<label for="url" title="The url that points directly to an item in your online store.">Item URL: </label>
	  		</td>
	  		<td>
